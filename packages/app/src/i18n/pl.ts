export const dict = {
  ...
  "toast.update.description": "Nowa wersja OpenWork ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenWork",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenWork",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenWork na swoim urządzeniu",
  ...
  "settings.general.row.theme.description": "Dostosuj motyw OpenWork.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenWork",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenWork.",
