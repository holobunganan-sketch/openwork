export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenWork wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
