...
import { OpenWorkMemoryProvider } from "@/context/openwork-memory"
    ...
    <MetaProvider>
      ...
      <ThemeProvider
        onThemeApplied={(_, mode, scheme) => {
          void optionalDesktopApi()?.setTitlebar?.({ mode, scheme })
        }}
      >
