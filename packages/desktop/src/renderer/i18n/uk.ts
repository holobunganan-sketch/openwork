export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію OpenWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} OpenWork завантажено. Бажаєте встановити її та перезапустити?",
