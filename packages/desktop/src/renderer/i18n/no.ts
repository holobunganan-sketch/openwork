export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenWork er lastet ned. Vil du installere den og starte på nytt?",
