...
export const dict = {
  ...
  "toast.update.description": "OpenWork 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 OpenWork 團隊",
  ...
  "home.title": "首頁",
  "openwork.home.title": "你想從什麼工作開始？",
  "openwork.presets.label": "任務預設",
  "openwork.home.description": "選擇一個常用任務，或開啟專案進入完整開發流程。",
  "openwork.home.projectRequired": "請先連線伺服器，再開始這些任務。",
  "openwork.composer.placeholder": "描述你想完成的工作。OpenWork 會檢查工作空間、補全安全的預設要求，並驗證最終結果。",
  "openwork.composer.start": "開始任務",
  "openwork.permission.controls": "控制項",
  "openwork.permission.title": "分項權限",
  "openwork.permission.description": "選擇 OpenWork 無需暫停即可執行的操作；任務中可隨時查看每項權限。",
  "openwork.permission.allow": "允許",
  "openwork.permission.ask": "詢問",
  "openwork.permission.alwaysAsk": "一律詢問",
  "openwork.permission.workspace": "工作空間編輯",
  "openwork.permission.workspace.description": "在所選工作空間內建立和更新檔案。",
  "openwork.permission.commands": "命令",
  "openwork.permission.commands.description": "執行非破壞性的 Shell 命令和本機工具。",
  "openwork.permission.network": "網路",
  "openwork.permission.network.description": "搜尋網路並讀取公開來源。",
  "openwork.permission.external": "外部操作",
  "openwork.permission.external.description": "使用 MCP 工具或在所選工作空間之外執行操作。",
  "openwork.permission.destructive": "破壞性操作",
  "openwork.autonomy.label": "執行模式",
  "openwork.autonomy.plan": "規劃",
  "openwork.autonomy.plan.description": "檢查材料並制定計畫，不進行修改。",
  "openwork.autonomy.collaborate": "協作",
  "openwork.autonomy.collaborate.description": "執行安全的工作空間修改，在關鍵或外部操作前詢問。",
  "openwork.autonomy.agent": "自動",
  "openwork.autonomy.agent.description": "自主完成工作空間內的安全操作，並驗證結果。",
  "openwork.manage": "Skills、MCP 與用量",
  "openwork.refresh": "重新整理",
  "openwork.task.document.title": "撰寫文件",
  "openwork.task.document.description": "起草、修改、摘要或排版文件。",
  "openwork.task.document.prompt":
    "根據工作空間中的素材製作一份專業、可編輯的文件。合理補全安全預設值，只詢問會實質影響結果的選擇，並驗證最終檔案。",
  "openwork.task.research.title": "研究主題",
  "openwork.task.research.description": "查找來源、比較證據並產生附引用的簡報。",
  "openwork.task.research.prompt":
    "使用可信來源研究這個主題，比較證據並交付一份附引用的精煉簡報。自行確定有用的範圍，並明確重要的不確定性。",
  "openwork.task.data.title": "分析資料",
  "openwork.task.data.description": "檢查並驗證資料集，清楚解釋發現。",
  "openwork.task.data.prompt":
    "檢查工作空間中可用的資料，驗證資料品質，分析最能支援決策的模式，並交付可編輯活頁簿和精煉結論。",
  "openwork.task.presentation.title": "製作簡報",
  "openwork.task.presentation.description": "將想法或素材整理成清楚的投影片。",
  "openwork.task.presentation.prompt":
    "把現有素材整理成邏輯清楚、視覺一致的簡報。合理推斷受眾和敘事結構，交付並驗證可編輯檔案。",
  "openwork.task.code.title": "開發軟體",
  "openwork.task.code.description": "實作、診斷、審查、測試並交付程式碼。",
  "openwork.task.code.prompt": "幫我完成這個專案中的軟體開發任務。請先檢查儲存庫，只詢問會實質影響實作的選擇。",
  "openwork.control.title": "OpenWork 控制中心",
  "openwork.tab.memory": "記憶",
  "openwork.tab.skills": "Skills",
  "openwork.tab.mcp": "MCP",
  "openwork.tab.usage": "Go 用量",
  "openwork.skills.description": "安裝經過驗證的 Skill ZIP，啟停、匯出受管 Skills，並可從自動備份復原。",
  "openwork.skills.listLabel": "已安裝的 Skills",
  "openwork.skills.install": "安裝 Skill ZIP",
  "openwork.skills.choose": "選擇 Skill ZIP",
  "openwork.skills.install.success": "Skill 已安裝，可在新工作階段中使用。",
  "openwork.skills.preview.files": "個已驗證檔案",
  "openwork.skills.preview.replace": "備份後取代現有 Skill",
  "openwork.skills.empty": "尚未安裝 Skills。",
  "openwork.skills.backupOnly": "可復原備份",
  "openwork.skills.saved": "Skill 狀態已儲存。",
  "openwork.skills.enable": "啟用",
  "openwork.skills.disable": "停用",
  "openwork.skills.export": "匯出",
  "openwork.skills.rollback": "回復",
  "openwork.skills.uninstall": "解除安裝",
  "openwork.skills.uninstalled": "Skill 已移除，並保留了可復原備份。",
  "openwork.skills.enabled": "已啟用",
  "openwork.skills.disabled": "已停用",
  "openwork.mcp.description":
    "貼上 OpenCode JSON/JSONC、Claude mcpServers JSON 或伺服器映射；偵測到的密鑰會移入加密保險庫。",
  "openwork.mcp.placeholder": "貼上含 mcp 或 mcpServers 的 JSON/JSONC…",
  "openwork.mcp.preview": "預覽",
  "openwork.mcp.import": "匯入",
  "openwork.mcp.import.success": "MCP 伺服器已匯入。",
  "openwork.mcp.restore": "復原最新備份",
  "openwork.mcp.saved": "MCP 設定已儲存。",
  "openwork.mcp.restartRequired": "已儲存。請重新啟動 OpenWork，使本機引擎套用此 MCP 變更。",
  "openwork.mcp.empty": "尚未設定 MCP 伺服器。",
  "openwork.mcp.secrets": "個加密密鑰",
  "openwork.usage.title": "OpenCode Go 用量",
  "openwork.usage.source": "來源",
  "openwork.usage.sessions": "個已檢查工作階段",
  "openwork.usage.period.five-hour": "滾動 5 小時",
  "openwork.usage.period.weekly": "滾動 7 天",
  "openwork.usage.period.monthly": "滾動 30 天",
  "openwork.usage.docs": "開啟 Go 官方文件",
  "openwork.settings.skills.title": "Skills",
  "openwork.settings.mcp.title": "MCP 連線",
  "openwork.settings.mcp.importTitle": "匯入 MCP 設定",
  "openwork.settings.mcp.importDescription":
    "貼上 OpenCode JSON/JSONC、Claude mcpServers 或伺服器對應。寫入前先檢查辨識到的連線和密鑰。",
  "openwork.settings.usage.title": "帳戶用量",
  "openwork.settings.usage.description": "查看可用的 OpenCode Go 官方用量，以及無法取得官方資料時清楚標示的本機估算。",
  "openwork.settings.memory.title": "記憶",
  "openwork.settings.memory.description":
    "管理 OpenWork 可以重複使用的偏好和專案事實。每則記憶都可見、有明確範圍、可停用，也可刪除。",
  "openwork.memory.new": "新增記憶",
  "openwork.memory.edit": "編輯記憶",
  "openwork.memory.editorDescription": "啟用的項目會加入符合任務的上下文，但不會擴大權限，也不會覆蓋目前證據。",
  "openwork.memory.listLabel": "已儲存的記憶",
  "openwork.memory.export": "匯出 JSON",
  "openwork.memory.exported": "記憶已匯出。",
  "openwork.memory.empty": "尚無記憶。只新增你希望 OpenWork 重複使用的事實或偏好。",
  "openwork.memory.scope": "適用範圍",
  "openwork.memory.scope.user": "所有工作空間",
  "openwork.memory.scope.project": "單一專案",
  "openwork.memory.project": "工作空間路徑",
  "openwork.memory.projectPlaceholder": "C:\\Work\\Project 或 /work/project",
  "openwork.memory.projectRequired": "專案記憶必須填寫工作空間路徑。",
  "openwork.memory.content": "希望 OpenWork 記住什麼",
  "openwork.memory.contentPlaceholder": "例如：交付說明保持精煉，並附上驗證證據。",
  "openwork.memory.contentRequired": "記憶內容不能為空。",
  "openwork.memory.save": "儲存",
  "openwork.memory.saved": "記憶已儲存。",
  "openwork.memory.enable": "啟用",
  "openwork.memory.disable": "停用",
  "openwork.memory.delete": "刪除",
  "openwork.memory.deleteConfirm": "永久刪除",
  "openwork.memory.deleted": "記憶已刪除。",
  "openwork.settings.status": "狀態",
  "openwork.settings.source": "來源",
  "openwork.settings.type": "類型",
  "openwork.settings.desktopOnly": "此 OpenWork 設定僅在桌面應用程式中可用。",
  "openwork.task.activity": "活動",
  "openwork.task.contract": "任務契約",
  "openwork.task.acceptance": "驗收標準",
  "openwork.task.constraints": "明確約束",
  "openwork.task.context": "上下文圖譜",
  "openwork.task.sources": "來源",
  "openwork.task.assumptions": "工作假設",
  "openwork.task.skillRouting": "Skill 路由",
  "openwork.task.permissions": "權限",
  "openwork.task.artifacts": "交付物",
  "openwork.task.verify": "驗證",
  "openwork.task.noArtifacts": "OpenWork 修改檔案後，這裡會顯示交付物及驗證證據。",
  "openwork.artifact.status.passed": "已驗證",
  "openwork.artifact.status.warning": "需要審閱",
  "openwork.artifact.status.failed": "驗證失敗",
  "openwork.artifact.kind.document": "文件",
  "openwork.artifact.kind.presentation": "簡報",
  "openwork.artifact.kind.spreadsheet": "試算表",
  "openwork.artifact.kind.research": "研究成果",
  "openwork.artifact.kind.software": "軟體變更",
  "openwork.artifact.kind.package": "安裝套件",
  "openwork.artifact.kind.file": "檔案",
  "openwork.artifact.check.exists": "檔案可開啟",
  "openwork.artifact.check.nonempty": "內容非空",
  "openwork.artifact.check.format": "檔案格式",
  "openwork.artifact.check.structure": "內容結構",
  "openwork.artifact.check.editable": "可編輯格式",
  "openwork.artifact.check.render": "轉譯與溢位檢查",
  "openwork.artifact.check.citations": "來源可追溯",
  "openwork.artifact.check.formulas": "公式驗證",
  "openwork.artifact.check.changes": "變更檔案範圍",
  "openwork.artifact.check.tests": "測試",
  "openwork.artifact.check.build": "建置與型別檢查",
  "openwork.artifact.check.smoke": "安裝與啟動煙霧測試",
  "openwork.source.workspace": "工作空間",
  "openwork.source.attachment": "附件",
  "openwork.source.context": "上下文",
  "openwork.source.mention": "提及",
  "openwork.source.memoryUser": "使用者記憶",
  "openwork.source.memoryProject": "專案記憶",
  "openwork.skillPhase.inspect": "檢查",
  "openwork.skillPhase.create": "產出",
  "openwork.skillPhase.verify": "驗證",
  "openwork.task.pause": "暫停",
  "openwork.task.continue": "繼續",
  "openwork.task.retry": "重試",
  "openwork.task.checkpoint": "儲存檢查點",
  "openwork.task.checkpoint.number": "檢查點 {{count}}",
  "openwork.task.restore": "復原",
  "openwork.task.status.draft": "草稿",
  "openwork.task.status.running": "執行中",
  "openwork.task.status.waiting": "等待中",
  "openwork.task.status.paused": "已暫停",
  "openwork.task.status.ready": "等待審閱",
  "openwork.task.status.failed": "需要處理",
  "openwork.task.status.completed": "已驗證",
  "openwork.task.activity.created": "任務已建立",
  "openwork.task.activity.started": "開始執行",
  "openwork.task.activity.resumed": "繼續執行",
  "openwork.task.activity.waiting": "等待輸入或重試",
  "openwork.task.activity.paused": "任務已暫停",
  "openwork.task.activity.ready": "結果可供審閱",
  "openwork.task.activity.failed": "操作失敗",
  "openwork.task.activity.checkpoint": "檢查點已儲存",
  "openwork.task.activity.verified": "結果已驗證",
  "home.projects": "專案",
  ...
  "settings.general.row.language.description": "變更 OpenWork 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 OpenWork 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 OpenWork 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OpenWork 的主題。",
  ...
  "settings.updates.row.startup.description": "在 OpenWork 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 OpenWork。",
