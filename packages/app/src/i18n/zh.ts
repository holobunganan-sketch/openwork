...
export const dict = {
  ...
  "toast.update.description": "OpenWork 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OpenWork 团队",
  ...
  "openwork.target.label": "任务目标环境",
  "openwork.workspace.label": "项目文件夹",
  "openwork.workspace.choose": "选择项目文件夹",
  "openwork.workspace.browse": "打开其他项目文件夹…",
  "openwork.workspace.required": "开始任务前请选择项目文件夹。",
  "openwork.model.label": "模型",
  "openwork.model.choose": "选择模型",
  "openwork.model.required": "开始任务前请选择或连接模型。",
  "openwork.starting.title": "正在启动 OpenWork 任务",
  "openwork.starting.description": "正在创建任务会话、应用项目文件夹和模型，并发送执行契约。",
  "openwork.permission.controls": "控制项",
  "openwork.permission.title": "分项权限",
  "openwork.permission.description": "选择 OpenWork 无需暂停即可执行的操作；任务中可随时查看每项权限。",
  "openwork.permission.allow": "允许",
  "openwork.permission.ask": "询问",
  "openwork.permission.alwaysAsk": "始终询问",
  "openwork.permission.workspace": "工作空间编辑",
  "openwork.permission.workspace.description": "在所选工作空间内创建和更新文件。",
  "openwork.permission.commands": "命令",
  "openwork.permission.commands.description": "运行非破坏性的 Shell 命令和本地工具。",
  "openwork.permission.network": "网络",
  "openwork.permission.network.description": "搜索网络并读取公开来源。",
  "openwork.permission.external": "外部操作",
  "openwork.permission.external.description": "使用 MCP 工具或在所选工作空间之外执行操作。",
  "openwork.permission.destructive": "破坏性操作",
  ...
  "openwork.tab.memory": "记忆",
  "openwork.tab.skills": "Skills",
  "openwork.tab.mcp": "MCP",
  "openwork.tab.usage": "Go 用量",
  "openwork.skills.description": "安装经过验证的 Skill ZIP，启停、导出受管 Skills，并可从自动备份恢复。",
  "openwork.skills.listLabel": "已安装的 Skills",
  "openwork.skills.install": "安装 Skill ZIP",
  "openwork.skills.choose": "选择 Skill ZIP",
  "openwork.skills.install.success": "Skill 已安装，可在新会话中使用。",
  "openwork.skills.preview.files": "个已验证文件",
  "openwork.skills.preview.replace": "备份后替换现有 Skill",
  "openwork.skills.empty": "尚未安装 Skills。",
  "openwork.skills.backupOnly": "可恢复备份",
  "openwork.skills.saved": "Skill 状态已保存。",
  "openwork.skills.enable": "启用",
  "openwork.skills.disable": "停用",
  "openwork.skills.export": "导出",
  ...
  "openwork.mcp.preview": "预览",
  "openwork.mcp.import": "导入",
  "openwork.mcp.import.success": "MCP 服务器已导入。",
  "openwork.mcp.restore": "恢复最新备份",
  "openwork.mcp.saved": "MCP 配置已保存。",
  "openwork.mcp.restartRequired": "已保存。请重启 OpenWork，使本地引擎应用此 MCP 变更。",
  "openwork.mcp.empty": "尚未配置 MCP 服务器。",
  "openwork.mcp.secrets": "个加密密钥",
  "openwork.usage.title": "OpenCode Go 用量",
  "openwork.usage.source": "来源",
  "openwork.usage.sessions": "个已检查会话",
  "openwork.usage.period.five-hour": "滚动 5 小时",
  ...
  "openwork.settings.memory.title": "记忆",
  "openwork.settings.memory.description":
    "管理 OpenWork 可以复用的偏好和项目事实。每条记忆都可见、有明确范围、可停用，也可删除。",
  "openwork.memory.new": "新建记忆",
  "openwork.memory.edit": "编辑记忆",
  "openwork.memory.editorDescription": "启用的条目会加入匹配任务的上下文，但不会扩大权限，也不会覆盖当前证据。",
  "openwork.memory.listLabel": "已保存的记忆",
  "openwork.memory.export": "导出 JSON",
  "openwork.memory.exported": "记忆已导出。",
  "openwork.memory.empty": "尚无记忆。只添加你希望 OpenWork 复用的事实或偏好。",
  "openwork.memory.scope": "适用范围",
  "openwork.memory.scope.user": "所有工作空间",
  "openwork.memory.scope.project": "单个项目",
  "openwork.memory.project": "工作空间路径",
  "openwork.memory.projectPlaceholder": "C:\\Work\\Project 或 /work/project",
  "openwork.memory.projectRequired": "项目记忆必须填写工作空间路径。",
  "openwork.memory.content": "希望 OpenWork 记住什么",
  "openwork.memory.contentPlaceholder": "例如：交付说明保持精炼，并附上验证证据。",
  "openwork.memory.contentRequired": "记忆内容不能为空。",
  "openwork.memory.save": "保存",
  "openwork.memory.saved": "记忆已保存。",
  "openwork.memory.enable": "启用",
  "openwork.memory.disable": "停用",
  "openwork.memory.delete": "删除",
  "openwork.memory.deleteConfirm": "永久删除",
  "openwork.memory.deleted": "记忆已删除。",
  ...
  "openwork.task.activity": "活动",
  "openwork.task.contract": "任务契约",
  "openwork.task.acceptance": "验收标准",
  "openwork.task.constraints": "明确约束",
  "openwork.task.context": "上下文图谱",
  "openwork.task.sources": "来源",
  "openwork.task.assumptions": "工作假设",
  "openwork.task.skillRouting": "Skill 路由",
  "openwork.task.permissions": "权限",
  "openwork.task.artifacts": "交付物",
  "openwork.task.verify": "验证",
  "openwork.task.noArtifacts": "OpenWork 修改文件后，这里会显示交付物及验证证据。",
  "openwork.artifact.status.passed": "已验证",
  "openwork.artifact.status.warning": "需要审阅",
  "openwork.artifact.status.failed": "验证失败",
  "openwork.artifact.kind.document": "文档",
  "openwork.artifact.kind.presentation": "演示文稿",
  "openwork.artifact.kind.spreadsheet": "表格",
  "openwork.artifact.kind.research": "研究成果",
  "openwork.artifact.kind.software": "软件变更",
  "openwork.artifact.kind.package": "安装包",
  "openwork.artifact.kind.file": "文件",
  "openwork.artifact.check.exists": "文件可打开",
  "openwork.artifact.check.nonempty": "内容非空",
  "openwork.artifact.check.format": "文件格式",
  "openwork.artifact.check.structure": "内容结构",
  "openwork.artifact.check.editable": "可编辑格式",
  "openwork.artifact.check.render": "渲染与溢出检查",
  "openwork.artifact.check.citations": "来源可追溯",
  "openwork.artifact.check.formulas": "公式验证",
  "openwork.artifact.check.changes": "变更文件范围",
  "openwork.artifact.check.tests": "测试",
  "openwork.artifact.check.build": "构建与类型检查",
  "openwork.artifact.check.smoke": "安装与启动烟测",
  "openwork.source.workspace": "工作空间",
  "openwork.source.attachment": "附件",
  "openwork.source.context": "上下文",
  "openwork.source.mention": "提及",
  "openwork.source.memoryUser": "用户记忆",
  "openwork.source.memoryProject": "项目记忆",
  "openwork.skillPhase.inspect": "检查",
  "openwork.skillPhase.create": "产出",
  "openwork.skillPhase.verify": "验证",
  "openwork.task.pause": "暂停",
  "openwork.task.continue": "继续",
  "openwork.task.retry": "重试",
  "openwork.task.checkpoint": "保存检查点",
  "openwork.task.checkpoint.number": "检查点 {{count}}",
  "openwork.task.restore": "恢复",
  "openwork.task.status.draft": "草稿",
  "openwork.task.status.running": "执行中",
  "openwork.task.status.waiting": "等待中",
  "openwork.task.status.paused": "已暂停",
  "openwork.task.status.ready": "等待审阅",
  "openwork.task.status.failed": "需要处理",
  "openwork.task.status.completed": "已验证",
  "openwork.task.activity.created": "任务已创建",
  "openwork.task.activity.started": "开始执行",
  "openwork.task.activity.resumed": "继续执行",
  "openwork.task.activity.waiting": "等待输入或重试",
  "openwork.task.activity.paused": "任务已暂停",
  "openwork.task.activity.ready": "结果可供审阅",
  "openwork.task.activity.failed": "操作失败",
  "openwork.task.activity.checkpoint": "检查点已保存",
  "openwork.task.activity.verified": "结果已验证",
  "home.projects": "项目",
  ...
  "settings.general.row.language.description": "更改 OpenWork 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 OpenWork 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OpenWork 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OpenWork 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OpenWork 启动时自动检查更新",
