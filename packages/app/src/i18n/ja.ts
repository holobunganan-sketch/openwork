...
export const dict = {
  ...
  "toast.update.description": "OpenWorkの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOpenWorkチームに報告してください: ",
  ...
  "settings.general.row.language.description": "OpenWorkの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOpenWorkの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OpenWorkがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OpenWorkのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OpenWork の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OpenWork は最新バージョンです。",
