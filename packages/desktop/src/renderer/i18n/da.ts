export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenWork er blevet downloadet. Vil du installere den og genstarte?",
