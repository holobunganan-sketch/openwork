export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenWork",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenWork a été téléchargée. Voulez-vous l'installer et redémarrer ?",
