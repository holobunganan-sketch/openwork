...
export const dict = {
  ...
  "toast.update.description": "OpenWork의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 OpenWork 팀에 제보해 주세요: ",
  ...
  "settings.general.row.language.description": "OpenWork 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 OpenWork가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "OpenWork가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "OpenWork 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "OpenWork를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 OpenWork를 사용 중입니다.",
