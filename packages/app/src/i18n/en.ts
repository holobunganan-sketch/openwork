export const dict = {
  ...
  "toast.update.description": "A new version of OpenWork ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenWork team",
  ...
  "openwork.permission.description":
    "Choose what OpenWork may do without pausing. You can review every scope in the task.",
  "openwork.permission.allow": "Allow",
  "openwork.permission.ask": "Ask",
  "openwork.permission.alwaysAsk": "Always ask",
  "openwork.permission.workspace": "Workspace edits",
  "openwork.permission.workspace.description": "Create and update files inside the selected workspace.",
  "openwork.permission.commands": "Commands",
  "openwork.permission.commands.description": "Run non-destructive shell commands and local tools.",
  "openwork.permission.network": "Network",
  "openwork.permission.network.description": "Search the web and retrieve public sources.",
  "openwork.permission.external": "External actions",
  "openwork.permission.external.description": "Use MCP tools or act outside the selected workspace.",
  "openwork.permission.destructive": "Destructive actions",
  ...
  "openwork.task.code.prompt":
    "Help me complete a software development task in this project. Inspect the repository first, then clarify only choices that materially affect the implementation.",
  "openwork.control.title": "OpenWork control center",
  "openwork.tab.memory": "Memory",
  ...
  "openwork.skills.preview.files": "files after validation",
  "openwork.skills.preview.replace": "replaces the current skill after backup",
  "openwork.skills.empty": "No skills are installed yet.",
  "openwork.skills.backupOnly": "recoverable backup",
  "openwork.skills.saved": "Skill state saved.",
  "openwork.skills.enable": "Enable",
  "openwork.skills.disable": "Disable",
  "openwork.skills.export": "Export",
  ...
  "openwork.mcp.preview": "Preview",
  "openwork.mcp.import": "Import",
  "openwork.mcp.import.success": "MCP servers imported.",
  "openwork.mcp.restore": "Restore latest backup",
  "openwork.mcp.saved": "MCP configuration saved.",
  "openwork.mcp.restartRequired": "Saved. Restart OpenWork to apply this MCP change to the local engine.",
  "openwork.mcp.empty": "No MCP servers are configured.",
  "openwork.mcp.secrets": "encrypted secret(s)",
  "openwork.usage.title": "OpenCode Go usage",
  "openwork.usage.source": "Source",
  "openwork.usage.sessions": "sessions inspected",
  "openwork.usage.period.five-hour": "Rolling 5 hours",
  ...
  "openwork.settings.memory.title": "Memory",
  "openwork.settings.memory.description":
    "Control the preferences and project facts OpenWork may reuse. Every entry is visible, scoped, optional, and removable.",
  "openwork.memory.new": "New memory",
  ...
  "openwork.memory.scope": "Scope",
  "openwork.memory.scope.user": "All workspaces",
  "openwork.memory.scope.project": "One project",
  "openwork.memory.project": "Workspace path",
  "openwork.memory.projectPlaceholder": "C:\\Work\\Project or /work/project",
  "openwork.memory.projectRequired": "A workspace path is required for project memory.",
  "openwork.memory.content": "What OpenWork should remember",
  "openwork.memory.contentPlaceholder": "Example: Keep handoffs concise and include verification evidence.",
  "openwork.memory.contentRequired": "Memory content is required.",
  "openwork.memory.save": "Save",
  "openwork.memory.saved": "Memory saved.",
  "openwork.memory.enable": "Enable",
  "openwork.memory.disable": "Disable",
  "openwork.memory.delete": "Delete",
  "openwork.memory.deleteConfirm": "Delete permanently",
  "openwork.memory.deleted": "Memory deleted.",
  ...
  "openwork.task.skillRouting": "Skill routing",
  "openwork.task.permissions": "Permissions",
  "openwork.task.artifacts": "Artifacts",
  "openwork.task.verify": "Verify",
  "openwork.task.noArtifacts": "Artifacts and verification evidence appear after OpenWork changes files.",
  "openwork.artifact.status.passed": "verified",
  "openwork.artifact.status.warning": "review needed",
  "openwork.artifact.status.failed": "failed",
  "openwork.artifact.kind.document": "document",
  "openwork.artifact.kind.presentation": "presentation",
  "openwork.artifact.kind.spreadsheet": "spreadsheet",
  "openwork.artifact.kind.research": "research",
  "openwork.artifact.kind.software": "software changes",
  "openwork.artifact.kind.package": "install package",
  "openwork.artifact.kind.file": "file",
  "openwork.artifact.check.exists": "File opens",
  "openwork.artifact.check.nonempty": "Content is not empty",
  "openwork.artifact.check.format": "File format",
  "openwork.artifact.check.structure": "Content structure",
  "openwork.artifact.check.editable": "Editable format",
  "openwork.artifact.check.render": "Render and overflow inspection",
  "openwork.artifact.check.citations": "Source traceability",
  "openwork.artifact.check.formulas": "Formula validation",
  "openwork.artifact.check.changes": "Changed-file scope",
  "openwork.artifact.check.tests": "Tests",
  "openwork.artifact.check.build": "Build and type checks",
  "openwork.artifact.check.smoke": "Install and launch smoke test",
  "openwork.source.workspace": "workspace",
  "openwork.source.attachment": "attachment",
  "openwork.source.context": "context",
  "openwork.source.mention": "mention",
  "openwork.source.memoryUser": "user memory",
  "openwork.source.memoryProject": "project memory",
  "openwork.skillPhase.inspect": "inspect",
  "openwork.skillPhase.create": "create",
  "openwork.skillPhase.verify": "verify",
  "openwork.task.pause": "Pause",
  "openwork.task.continue": "Continue",
  "openwork.task.retry": "Retry",
  "openwork.task.checkpoint": "Checkpoint",
  "openwork.task.checkpoint.number": "Checkpoint {{count}}",
  "openwork.task.restore": "Restore",
  "openwork.task.status.draft": "Draft",
  "openwork.task.status.running": "Working",
  "openwork.task.status.waiting": "Waiting",
  "openwork.task.status.paused": "Paused",
  "openwork.task.status.ready": "Ready to review",
  "openwork.task.status.failed": "Needs attention",
  "openwork.task.status.completed": "Verified",
  "openwork.task.activity.created": "Task created",
  "openwork.task.activity.started": "Work started",
  "openwork.task.activity.resumed": "Work resumed",
  "openwork.task.activity.waiting": "Waiting for input or retry",
  "openwork.task.activity.paused": "Task paused",
  "openwork.task.activity.ready": "Result ready to review",
  "openwork.task.activity.failed": "Action failed",
  "openwork.task.activity.checkpoint": "Checkpoint saved",
  "openwork.task.activity.verified": "Result verified",
  ...
  "settings.general.row.language.description": "Change the display language for OpenWork",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenWork looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenWork follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenWork is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenWork launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenWork.",
