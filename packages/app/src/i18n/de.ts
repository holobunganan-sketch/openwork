...
export const dict = {
  ...
  "toast.update.description": "Eine neue Version von OpenWork ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenWork-Team",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenWork ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenWork auf Ihrem Gerät aussieht",
  ...
  "settings.general.row.theme.description": "Das Thema von OpenWork anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenWork automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OpenWork.",
