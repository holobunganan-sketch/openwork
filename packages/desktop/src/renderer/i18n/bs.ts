export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenWork-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenWork-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
