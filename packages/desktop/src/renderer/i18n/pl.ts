export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenWork. Czy chcesz ją zainstalować i uruchomić ponownie?",
